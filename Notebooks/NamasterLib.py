...
class Namaster(object):
    ...
    def bin_spectra(self, input_cls, nside):
        ...
        input_cls_reshape = np.reshape(input_cls, (input_cls.shape[0], input_cls.shape[-1]))
        #print(input_cls_reshape.shape)
    ...
    def get_fields(self, map_, mask_apo=None, purify_e=False, purify_b=True, beam_correction=None):
        """
    ...
    def get_spectra(self, map_, mask_apo=None, map2=None, purify_e=False, purify_b=True, w=None,
        ...
        """
        nside = hp.npix2nside(len(map_[0]))
        ...
        # Get fields
        f0, f2 = self.get_fields(map_, mask_apo=mask_apo,
                                 purify_e=purify_e,
                                 purify_b=purify_b,
