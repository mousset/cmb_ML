...
```{python colab={'base_uri': 'https://localhost:8080/', 'height': 139}, colab_type=code, executionInfo={'elapsed': 5147, 'status': 'ok', 'timestamp': 1562852657184, 'user': {'displayName': 'X.D.topher sama', 'photoUrl': 'https://lh5.googleusercontent.com/-bezrQ2Sgsnc/AAAAAAAAAAI/AAAAAAAACa4/mLbI1TQOnSM/s64/photo.jpg', 'userId': '09059908567566041974'}, 'user_tz': -120}, id=8FvWTuITh0RN, outputId=041d1fd5-da87-4ef0-bf25-a8195ac14cee}
# #!pip install camb
# #!pip install healpy
# !git clone https://github.com/gonzalezm/NNhealpix.git
```

```{python colab={'base_uri': 'https://localhost:8080/', 'height': 156}, colab_type=code, executionInfo={'elapsed': 2607, 'status': 'ok', 'timestamp': 1562852508182, 'user': {'displayName': 'X.D.topher sama', 'photoUrl': 'https://lh5.googleusercontent.com/-bezrQ2Sgsnc/AAAAAAAAAAI/AAAAAAAACa4/mLbI1TQOnSM/s64/photo.jpg', 'userId': '09059908567566041974'}, 'user_tz': -120}, id=ww6ZiT_rQ9-i, outputId=e2cfdb13-dc40-49b5-8c44-d87713f9f484}
 !python NNhealpix/setup.py develop --user
```

```{python colab={}, colab_type=code, id=4emXZv4rNHxR}
# !rm -r nnhealpix.egg-info
```

```{python colab={}, colab_type=code, id=Yw0Ib7KOPxro}
# !cd NNhealpix/
```

```{python colab={'base_uri': 'https://localhost:8080/', 'height': 34}, colab_type=code, executionInfo={'elapsed': 2160, 'status': 'ok', 'timestamp': 1562852634203, 'user': {'displayName': 'X.D.topher sama', 'photoUrl': 'https://lh5.googleusercontent.com/-bezrQ2Sgsnc/AAAAAAAAAAI/AAAAAAAACa4/mLbI1TQOnSM/s64/photo.jpg', 'userId': '09059908567566041974'}, 'user_tz': -120}, id=2GQLR6AvOMm_, outputId=b0035dc9-4bed-4855-b288-011a98bbce71}
# !ls -a
```

```{python colab={'base_uri': 'https://localhost:8080/', 'height': 305}, colab_type=code, executionInfo={'elapsed': 404, 'status': 'error', 'timestamp': 1562852738602, 'user': {'displayName': 'X.D.topher sama', 'photoUrl': 'https://lh5.googleusercontent.com/-bezrQ2Sgsnc/AAAAAAAAAAI/AAAAAAAACa4/mLbI1TQOnSM/s64/photo.jpg', 'userId': '09059908567566041974'}, 'user_tz': -120}, id=YNvBh4RQNMCy, outputId=eed897fe-904d-4f4c-e17b-76f4688168f3}
import NNhealpix
```

```{python colab={'base_uri': 'https://localhost:8080/', 'height': 139}, colab_type=code, executionInfo={'elapsed': 18314, 'status': 'ok', 'timestamp': 1562850594207, 'user': {'displayName': 'X.D.topher sama', 'photoUrl': 'https://lh5.googleusercontent.com/-bezrQ2Sgsnc/AAAAAAAAAAI/AAAAAAAACa4/mLbI1TQOnSM/s64/photo.jpg', 'userId': '09059908567566041974'}, 'user_tz': -120}, id=IoFancfhh9HJ, outputId=c2705bc9-486c-44e4-c821-eea435ea5c1c}
import camb
...
```{python colab={'base_uri': 'https://localhost:8080/', 'height': 69}, colab_type=code, executionInfo={'elapsed': 18270, 'status': 'ok', 'timestamp': 1562850594230, 'user': {'displayName': 'X.D.topher sama', 'photoUrl': 'https://lh5.googleusercontent.com/-bezrQ2Sgsnc/AAAAAAAAAAI/AAAAAAAACa4/mLbI1TQOnSM/s64/photo.jpg', 'userId': '09059908567566041974'}, 'user_tz': -120}, id=7TvrWXl6h_ZB, outputId=d2ff87a2-1933-4c72-a29f-c3c54c491ebd}
print(ls[0])
CL = totCL[:,0]/ls/(ls+1)
CL[0]=0
...
```{python colab={}, colab_type=code, id=LqYJB5whiEZ4}
...
```{python colab={'base_uri': 'https://localhost:8080/', 'height': 375}, colab_type=code, executionInfo={'elapsed': 473, 'status': 'error', 'timestamp': 1562851326446, 'user': {'displayName': 'X.D.topher sama', 'photoUrl': 'https://lh5.googleusercontent.com/-bezrQ2Sgsnc/AAAAAAAAAAI/AAAAAAAACa4/mLbI1TQOnSM/s64/photo.jpg', 'userId': '09059908567566041974'}, 'user_tz': -120}, id=crgTOGoeiO3n, outputId=85009fe3-9979-49b5-f3be-6ec8e8f6ddf8}
...
```{python colab={}, colab_type=code, id=mY_SROHhnquB}
...
```{python colab={}, colab_type=code, id=iDECsUpViXJ8}
...
```{python colab={}, colab_type=code, id=Klsgle0HFeHc}
...
```{python colab={}, colab_type=code, id=z3uvqa_nBiXU}
import numpy as np
lt=np.arange(nl)
...
```{python colab={}, colab_type=code, id=q-WS5WPEOZ9b}
figure()
...
```{python colab={}, colab_type=code, id=BNl3317hRi4f}
...
```{python colab={}, colab_type=code, id=zthM1tP6VMwe}
#np.save(out_dir + today + "_loss-alm", history.history['loss'])
#np.save(out_dir + today + "_val_loss-alm", history.history['val_loss'])
```

```{python colab={}, colab_type=code, id=hl1_uBtCXSWy}
#np.save(out_dir + today + "_mymaps", mymaps)

```

```{python colab={}, colab_type=code, id=D1nca46YYhGI}

```

<!-- #region {"colab_type": "text", "id": "nUMjgmETG9Lv"} -->
...
<!-- #region {"colab_type": "text", "id": "OqPKY6VRBJHS"} -->
# Conclusion
...
<!-- #region {"colab_type": "text", "id": "WfoyXYywBM0c"} -->
